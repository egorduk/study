...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpeg|jpg|png|bmp)$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => '/\.(gif|png|jpeg|jpg|bmp|doc|docx|pdf|xls|xlsx|pptx|ppt|pptm|rar|zip|txt)$/i',
            ...
            'image_file_types' => '/\.(gif|jpg|jpeg|bmp|png)$/i',
