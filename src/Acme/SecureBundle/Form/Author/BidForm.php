...
class BidForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('fieldSum', 'text', array('required' => true, 'label'=>'Сумма:', 'data' => $options['data']->fieldSum, 'attr' => array('class' => 'form-control', 'title' => 'Введите сумму за выполнение заказа', 'size' => 30, 'maxlength' => 6, 'placeholder' => 'Введите сумму')))
                ->add('fieldDay', 'text', array('required' => true, 'label'=>'Количество дней:', 'data' => $options['data']->fieldDay, 'attr' => array('class' => 'form-control', 'title' => 'Введите количество дней на выполнение заказа', 'size' => 30, 'maxlength' => 4, 'placeholder' => 'Введите количество дней')))
                ...
                ->add('isClientDate', 'checkbox', array('label'=>'В срок', 'required' => false, 'attr' => array('class' => '', 'title' => 'Установите флажок, если Вы согласны со сроком заказчика')))
                ->add('bid', 'submit', array('label'=>'', 'attr' => array('class' => 'hidden')))
